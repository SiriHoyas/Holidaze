...
describe("matchesKeyword", () => {
  it("should return true if the venue name includes the keyword", () => {
  ...
  it("should return false if the venue name and location does not include the keyword", () => {
  ...
  it("should return false if the venue has no name or location", () => {
